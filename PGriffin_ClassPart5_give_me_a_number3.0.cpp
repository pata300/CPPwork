/*
	...
	Date:		4/6/2017
	Filename:	PGriffin_ClassPart5_give_me_a_number3.0.cpp
...
int main()
{
    int number = askNumber(999);//call 'askNumber()' w/ 'high' assigned 5; default of 1 assiged to 'low'
    cout << "Thanks for entering: " << number << "\n\n";//output 'number'
    
    number = askNumber(10000, 1000);//call 'askNumber()' w/ new parameters; assign 10 to 'high' & 5 to 'low'
    cout << "Thanks for entering: " << number << "\n\n";//output new 'number'
