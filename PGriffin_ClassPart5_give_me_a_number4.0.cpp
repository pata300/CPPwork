/*
	...
	Date:		4/6/2017
	Filename:	PGriffin_ClassPart5_give_me_a_number4.0.cpp
...
int main()
{
    int number = askNumber(9999);//call 'askNumber()' w/ 'high' assigned 5; default of 1 assiged to 'low'
    cout << "Thanks for entering: " << number << "\n\n";//output 'number'
    
    number = askNumber(1000000000, 999999);//call 'askNumber()' w/ new parameters; assign 10 to 'high' & 5 to 'low'
    cout << "Thanks for entering: " << number << "\n\n";//output new 'number'
