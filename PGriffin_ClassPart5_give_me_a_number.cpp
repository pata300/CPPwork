/*
	...
	Date:		4/6/2017
	Filename:	PGriffin_ClassPart5_give_me_a_number.cpp
...
int main()
{
    int number = askNumber(5);//call 'askNumber()' w/ 'high' assigned 5; default of 1 assiged to 'low'
    cout << "Thanks for entering: " << number << "\n\n";//output 'number'
    
    number = askNumber(10, 5);//call 'askNumber()' w/ new parameters; assign 10 to 'high' & 5 to 'low'
    cout << "Thanks for entering: " << number << "\n\n";//output new 'number'
